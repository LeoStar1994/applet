<template>
  <a-layout :class="['admin-layout', 'beauty-scroll']">
    ...
    <side-menu :class="[fixedSideBar ? 'fixed-side' : '']"
               :theme="theme.mode"
    ...
    <a-layout class="admin-layout-main beauty-scroll">
      ...
      <a-layout-header :class="['virtual-header', {'fixed-tabs' : fixedTabs, 'fixed-header': fixedHeader, 'multi-page': multiPage}]"
...
// import Setting from "../components/setting/Setting"; // 右侧setting组件
